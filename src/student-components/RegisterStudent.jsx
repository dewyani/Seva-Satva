...
export default function RegisterStudent()
{
    ...
    <form onSubmit={handleSubmit} className="register--form  registerstudent--form">
    ...
    <div>
    <label htmlFor="uidid" className='block'>UID</label>
    <input type="number" 
            name="uid"
            id="uidid"
            placeholder='UID'
    ...
    <div>
    <label htmlFor="branchid" className='block'>Branch</label>
    <select name="branch" 
    id="branchid" 
    onChange={handleChange}
